## Produce the second required plot for Exploratory Data Anaylsis, Project 1
...
## Construct and save Plot 2 as a PNG file
png("plot2.PNG", width = 480, height = 480)
plot(data$datetime, data$Global_active_power, "l", xlab = "", 
